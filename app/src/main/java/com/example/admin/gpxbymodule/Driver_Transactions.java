...
public class Driver_Transactions extends AppCompatActivity
    ...
    public void sidenavMain(){
        ...
        NavAdapter ad = new NavAdapter(Driver_Transactions.this, listitem);
        lv.setAdapter(ad);
    ...
    public void subMenu(){
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (sel){
                    case "Log Out":
                        final AlertDialog.Builder builder = new AlertDialog.Builder(Driver_Transactions.this);
                        builder.setMessage("Confirm logout?")
                                .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int id) {
                                        helper.logout();
                                        startActivity(new Intent(Driver_Transactions.this, Login.class));
                                        finish();
                                    }
                                })
    ...
    public void spinnerlist(){
        try {
            String[] items = new String[]{"All", "New Customer", "Reservations",
                    "Booking", "Remittance", "Incident"};
            adapter =
                    new ArrayAdapter<>(this, R.layout.spinneritem, items);
