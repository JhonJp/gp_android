...
public class CaptureSign extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.capture_sign);
        ...
        mSignature.setBackgroundColor(getResources().getColor(R.color.gray));
        mContent.addView(mSignature, LayoutParams.FILL_PARENT, LayoutParams.FILL_PARENT);
        mClear = (Button)findViewById(R.id.clearsign);
        mGetSign = (Button)findViewById(R.id.savesign);
        mGetSign.setEnabled(false);
        mCancel = (Button)findViewById(R.id.cancelsign);
        mView = mContent;
