...
public class ListViewItemCheckboxBaseAdapter extends BaseAdapter {
    ...
    public View getView(int itemIndex, View convertView, ViewGroup viewGroup) {
        ...
        }else
        {
            ...
            TextView subitem = (TextView) convertView.findViewById(R.id.list_view_item_sub);

            viewHolder = new ListViewItemViewHolder(convertView);

            viewHolder.setItemCheckbox(listItemCheckbox);
            viewHolder.setItemTextView(listItemText);
            viewHolder.setSubitem(subitem);
        ...
        viewHolder.getSubitem().setText(listViewItemDto.getItemsub());
